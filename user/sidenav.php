  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="dashboard.php" class="logo d-flex align-items-center">
        <img src="" alt="">
        <span class="d-none d-lg-block">FreeGain</span>
      </a>
...
<!-- 
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="survey.php">
          <i class="bi bi-menu-button-wide"></i><span>Survey</span><i class="bi bi-chevron-down ms-auto"></i>
        </a> -->
<!-- Add Here Survey Component -->
...
<!-- </li>End Components Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="ptcad.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="shortlinks.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="play.php">
